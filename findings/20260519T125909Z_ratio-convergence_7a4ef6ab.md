...
params: {"n": 29}
generated_at: 2026-05-19T12:59:09.322317+00:00
library: recursive_field_math
---

# Lucas ratio convergence at n=29
...
- L(n+1)/L(n) = **1.6180339887515860**
- φ           = **1.6180339887498949**
- Observed |err|     = **1.691e-12**
- Lower error bound  = **1.691e-12**
- Upper error bound  = **1.691e-12**
- Within bounds?     = **False**
